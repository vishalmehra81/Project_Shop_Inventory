...
product_1 = Product("Atlante White/Blue/Red ", brand_1, stock_1, "Helmet", "XL", 152.99, 359.99)
product_repository.save(product_1)

product_2 = Product("Commander - Matt Orange Fluo", brand_2, stock_2, "Helmet", "XL", 143.99, 289.99)
product_repository.save(product_2)

product_3 = Product("Subverter - Power Chrome/Blue", brand_3, stock_3, "Helmet", "L", 123.99, 199.99)
product_repository.save(product_3)

product_4 = Product("C4 - Legacy Yellow", brand_4, stock_4, "Helmet", "M", 219.99, 649.99)
product_repository.save(product_4)

product_5 = Product("N53 - Portland LED Yellow 060", brand_5, stock_5, "Helmet", "L", 101.99, 161.99)
product_repository.save(product_5)

product_6 = Product("Dyno V2 Leather Jacket - Navy", brand_6, stock_6, "Clothing", "XL", 201.99, 379.99)
product_repository.save(product_6)

product_7 = Product("Girona 1.0 Ladies Textile Jacket - Purple", brand_7, stock_7, "Clothing", "M", 51.99, 119.99)
product_repository.save(product_7)

product_8 = Product("IOM TT Brandish Leather Jacket - Oxblood", brand_8, stock_8, "Clothing", "XL", 109.99, 269.99)
product_repository.save(product_8)

product_9 = Product("Debbie Ladies Leather Jacket - Bordeaux", brand_9, stock_9, "Clothing", "L", 101.99, 287.99)
product_repository.save(product_9)

product_10 = Product("Kelly Ladies Leather Trousers - Black", brand_10, stock_10, "Clothing", "M", 56.99, 119.99)
product_repository.save(product_10)

product_11 = Product(" SMX-6 v2 Drystar® Boots - Black", brand_6, stock_11, "Boots", "M", 119.99, 219.99)
product_repository.save(product_11)

product_12 = Product("Rainseal Over Boots - Black", brand_7, stock_12, "Boots", "L", 11.99, 21.99)
product_repository.save(product_12)

product_13 = Product("Raid WP Boots - Brown", brand_8, stock_13, "Boots", "M", 89.99, 143.99)
product_repository.save(product_13)

product_14 = Product("Melbourne D3O WP Boots - Black", brand_9, stock_14, "Boots", "L", 103.99, 189.99)
product_repository.save(product_14)

product_15 = Product("Crossfire 3 SRS Boots - Blue/Yellow", brand_11, stock_15, "Boots", "L", 147.99, 359.99)
product_repository.save(product_15)

product_16 = Product("Apex V2 Drystar® Glove - Black", brand_6, stock_16, "Gloves", "M", 34.99, 84.99)
product_repository.save(product_16)

product_17 = Product("RP-4 Gloves - Black/White", brand_7, stock_17, "Gloves", "L", 15.99, 49.99)
product_repository.save(product_17)

product_18 = Product("Volt Gloves - Black/Red", brand_8, stock_18, "Gloves", "M", 15.99, 49.99)
product_repository.save(product_18)

product_19 = Product("Volt Gloves - Black/Red", brand_9, stock_19, "Gloves", "L", 23.99, 56.99)
product_repository.save(product_19)

product_20 = Product("Freeride WP Glove - Tan", brand_12, stock_20, "Gloves", "L", 24.99, 45.99)
